...
const AboutPlatform = () => {
  return (
    <Element name="About Platform">
      <AboutPlatformSection>
        <GradientText text={"About Platform"} textType="huge" />
        <RegularTextWrapper>
          <HeaderText text="Teameights offers a comprehensive solution by providing a platform where students and professionals can gain practical programming experience through a variety of real-world-oriented activities. " />
        </RegularTextWrapper>
              ...
              <CardContainer>
                <InfoContainer>
                  ...
                  <Description>
                    ...
                    for collaborative work. Form teams, engage in group
                    projects, and learn from one another in a supportive
                    environment.
                  </Description>
                </InfoContainer>
              </CardContainer>
            ...
            <RightColumnContainer>
              ...
              <CardContainer>
                <InfoContainer>
                  ...
                  <Description>
                    Benefit from our mentorship program, connecting newcomers
                    with experienced mentors in the field. Receive personalized
          ...
          <DoubleCardContainer>
            <CardContainer>
              <InfoContainer>
                ...
                <Description>
                  Engage in fast-paced coding battles against fellow coders.
                  Solve problems under timed conditions and strive to climb the
                  leaderboard.
                </Description>
              </InfoContainer>
            </CardContainer>
