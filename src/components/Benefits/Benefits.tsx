...
const Benefits = () => {
  return (
    <Element name="Beta Test Benefits">
      <BenefitsSection>
        ...
        <BenefitsWrapper>
          <BenefitsItem>
            ...
            <BenefitsText>
              ...
              <SupportingTextWrapper>
                You will have the exclusive opportunity to explore and utilize
                all cutting-edge features, functionalities, and tools of our
                platform before it is officially launched to the public.{" "}
              </SupportingTextWrapper>
            </BenefitsText>
          </BenefitsItem>
          <BenefitsItem>
          ...
          <BenefitsItem>
            ...
            <BenefitsText>
              ...
              <SupportingTextWrapper>
                Your feedback and input will directly influence the development
                of our platform, helping us make it even better to meet your
